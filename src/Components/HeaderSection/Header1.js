    ...
    return(
        ...
        <div className="row border-top px-xl-5">
            <div className="col-lg-3 d-none d-lg-block ">
                <a className="btn shadow-none d-flex align-items-center justify-content-between  text-white w-100 collapsed border-0" data-toggle="collapse" href="#navbar-vertical" style={{height: "65px", marginTop: "-1px", padding: "0 30px",backgroundColor:"lightsteelblue", ariaExpanded:"false"}}>
                    <h6 className="m-0">Categories</h6>
                    <i className="fa fa-angle-down text-dark"></i>
                </a>
                <nav className="position-absolute navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 bg-clrr collapse" id="navbar-vertical" style={{width: "calc(100% - 24px)", zIndex: "1"}}>
