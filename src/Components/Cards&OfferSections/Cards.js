  ...
  return (
    ...
    <div className='container-fluid'>
      ...
      <div className='container col-lg-3 col-md-6 col-sm-12 pb-1 '>
        ...
        <CheckIcon style={{color:"mediumblue",width:"58px",height:'40px'}}/>
      ...
      <div style={{backgroundColor:"white",padding:"10px 10px",display:"flex", alignItems:"center", margin:"20px"}}>
        <LocalShippingIcon style={{color:"mediumblue",width:"58px",height:'40px'}}/>
        <h2 style={{paddingLeft:"10px",fontSize:"23px"}}>
          Free Shipping
        </h2>
      </div>
      ...
      <div className='d-flex align-items-center justify-content-center border'>
        <div style={{backgroundColor:"white", padding:"10px 10px",display:"flex", alignItems:"center",margin:"20px"}}>
        <SwapHorizIcon style={{color:"mediumblue",width:"58px",height:'40px'}}/>
        <h2 style={{paddingLeft:"10px",fontSize:"23px"}}>
          14-Day Return
        </h2>
      </div>
      ...
      <div className='d-flex align-items-center justify-content-center border'>
        <div style={{backgroundColor:"white", padding:"10px 10px",display:"flex", alignItems:"center",margin:"20px"}}>
        <WifiCalling3Icon style={{color:"mediumblue",width:"58px",height:'40px'}}/>
        <h2 style={{paddingLeft:"10px",fontSize:"23px"}}>
          24/7 Support
        </h2>
      </div>
