...
const card = () => {
  return (
    ...
    <div className='container-fluid'>
      ...
      <div style={{backgroundColor:"white",padding:"10px 10px",display:"flex", alignItems:"center", margin:"20px"}}>
        <LocalShippingIcon style={{color:"steelblue",width:"58px",height:'40px'}}/>
      ...
      <div className='d-flex align-items-center justify-content-center border'>
        <div style={{backgroundColor:"white", padding:"10px 10px",display:"flex", alignItems:"center",margin:"20px"}}>
        <SwapHorizIcon style={{color:"steelblue",width:"58px",height:'40px'}}/>
        <h2 style={{paddingLeft:"10px",fontSize:"23px"}}>
          14-Day Return
        </h2>
      </div>
      ...
      <div className='d-flex align-items-center justify-content-center border'>
        <div style={{backgroundColor:"white", padding:"10px 10px",display:"flex", alignItems:"center",margin:"20px"}}>
        <WifiCalling3Icon style={{color:"steelblue",width:"58px",height:'40px'}}/>
        <h2 style={{paddingLeft:"10px",fontSize:"23px"}}>
          24/7 Support
        </h2>
      </div>
